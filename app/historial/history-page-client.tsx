...
export default function HistoryPageClient() {
  ...
  const matchesPet =
    petIdParam ? r.petId === petIdParam : true
  ...
  const matchesService =
    service ? r.serviceId === service : true
  ...
  return (
    <div className="min-h-screen bg-amber-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 space-y-6">
        ...
        {petIdParam && (
            <div className="bg-amber-100 border border-amber-300 text-amber-900 px-4 py-2 rounded-lg">
              Mostrando historial de esta mascota
            </div>
          )}
        <HistoryFilters
          search={search}
